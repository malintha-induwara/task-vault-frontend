    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="px-4 py-2 bg-blue-600 text-white rounded-md h-fit hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 flex items-center justify-center transition-colors"
        >
           <Plus size={18} />
          Add Task
        </button>
